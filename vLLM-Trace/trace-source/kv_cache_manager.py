...
import itertools
import json  # pingtao add
import os  # pingtao add
import time  # pingtao add
from collections.abc import Sequence
from dataclasses import dataclass
from typing import Any, Literal, overload  # pingtao modify
...
# R2 TTFT INSTRUMENTATION -- HBM PREFIX-CACHE LOOKUP TRACE OUTPUT
def _write_hbm_lookup_trace(event: str, request_id: str, **fields: Any) -> None:  # pingtao add
...
class KVCacheManager:
    ...
    def get_computed_blocks(self, request: Request) -> tuple[KVCacheBlocks, int]:
        ...
        lookup_start_ns = time.perf_counter_ns()  # pingtao add
        ...
        _write_hbm_lookup_trace(  # pingtao add
            "hbm_lookup",  # pingtao add
            request.request_id,  # pingtao add
            elapsed_ms=lookup_ms,  # pingtao add
            hit_tokens=num_new_computed_tokens,  # pingtao add
        )  # pingtao add
